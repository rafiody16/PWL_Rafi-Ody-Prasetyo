    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <a class="btn btn-sm btn-primary mt-1" href="{{ url('/user/export_excel') }}"><i
                        class="fa fa-file-excel">Export User</i></a>
                <a class="btn btn-sm btn-warning mt-1" href="{{ url('/user/export_pdf') }}"><i class="fa fa-file-pdf">Export
                        User</i></a>
            </div>
        </div>
        <div class="card-body">
