    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <a class="btn btn-sm btn-primary mt-1" href="{{ url('/supplier/export_excel') }}"><i
                        class="fa fa-file-excel">Export Level</i></a>
                <a class="btn btn-sm btn-warning mt-1" href="{{ url('/supplier/export_pdf') }}"><i
